...
import { contextColours, contextLabels } from '../../data/activities';
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-2 flex-wrap">
            {activity.effort === 'low' && (
              <span className="text-[10px] font-semibold text-[#7D9B76] bg-[#F0F7EE] px-1.5 py-0.5 rounded">
                Low effort
              </span>
            )}
            {activity.durationMinutes !== undefined && activity.durationMinutes <= 5 && (
              <span className="text-[10px] font-semibold text-[#6A5A9C] bg-[#F0E8FF] px-1.5 py-0.5 rounded">
